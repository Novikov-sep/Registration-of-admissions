...
if (isMobile.any()) {
   document.querySelector('.footer__title1').classList.add('_spoller');
}
if (isMobile.any()) {
   document.querySelector('.footer__title2').classList.add('_spoller');
}
if (isMobile.any()) {
   document.querySelector('.footer__title3').classList.add('_spoller');
}
...
let slider_about = new Swiper('.slider-programs', {
   //effect: 'fade',
   autoplay: {
      delay: 3000,
...
let slider_second = new Swiper('.exx__slider', {
   autoplay: {
      delay: 3000,
      disableOnInteraction: false
   },
